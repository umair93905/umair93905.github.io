...
<section class="details-grid reveal">
  ...
  <article class="detail-card">
    ...
    <ul>
      ...
      <li>Currently studying Computer Engineering at UET Faisalabad</li>
    </ul>
  </article>
  ...
  <article class="detail-card">
    ...
    <ul>
      ...
      <li>Consistency builds confidence, especially in technical subjects</li>
    </ul>
  </article>
</section>
...
<section class="section-panel reveal">
  ...
  <div class="spotlight-grid">
    <article class="spotlight-card">
      <h3>Programming</h3>
      <p>My studies in Programming Fundamentals and Object-Oriented Programming are helping me develop logic, structure, and coding confidence.</p>
    </article>
    <article class="spotlight-card">
      <h3>Database Management</h3>
      <p>I am learning how data is organized, connected, and managed through keys, tables, SQL queries, and practical database design.</p>
    </article>
    <article class="spotlight-card">
      <h3>Project Learning</h3>
      <p>My machine learning project introduced me to teamwork, data visualization, and applying technology to real-world problems.</p>
    </article>
  </div>
</section>
